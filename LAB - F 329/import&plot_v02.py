...
# o buffer com esse valor (e repete); se forem iguais, ele adiciona na última sublista previamente criada (a primeira sublista
# sempre é criada, pois o primeiro nunca é igual ao último).
